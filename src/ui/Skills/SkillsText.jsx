function SkillsText() {
  return (
    <div>
      <p>
        <span className="blue-bold">Desarrollo Frontend:</span> Mi conjunto de
        ...
        usuario atractivas y responsivas.
      </p>
      <p>
        ...
        <span className="blue-bold">AWS</span>, y utilizo{' '}
        <span className="blue-bold">Docker</span> y{' '}
        <span className="blue-bold">GitHub Actions</span> para automatizar los
        flujos de trabajo de desarrollo y asegurar despliegues seguros.
      </p>
      <p>
        <span className="blue-bold">DevOps y más:</span> Mi enfoque está
        centrado en DevOps, buscando mejorar la eficiencia y calidad en el ciclo
        de vida del desarrollo de software. Siempre estoy explorando nuevas
        tecnologías, como <span className="blue-bold">OpenAI</span>, para
        integrar inteligencia artificial en mis proyectos y mejorar su
        funcionalidad. También tengo experiencia en la implementación de
        microservicios utilizando <span className="blue-bold">RabbitMQ</span>{' '}
        como broker de colas, lo que me permite diseñar arquitecturas robustas y
